...
function Ordenar2(props){
    ...
    function handlerchange(event){
        if (event.target.name==="ascendente"){
            ...
            if (choice==="AZ"){
                return props.alfabetic(props.pokemonlist)
            }
            else if (choice==="ZA"){
                return props.noalfabetic(props.pokemonlist)
            }else{
                return
            }
        }
        if (event.target.name==="tipos"){
            ...
            props.tipos(props.pokemonlist,choice2)
        }
        forceUpdate()
    }
